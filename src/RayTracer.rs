...
pub mod RayTracerDemo {
    ...
    pub mod RayTracer {
        ...
        pub struct Scene {
            ...
            pub Lights: Rc<MutCell<Vec<RayTracerDemo::RayTracer::Light>>>,
        ...
        pub fn GetNaturalColor(thing:
         ...
         -> RayTracerDemo::Color {
            ...
            {
                let arr: Rc<MutCell<Vec<RayTracerDemo::RayTracer::Light>>> =
                    scene.Lights.clone();
                for idx in 0i32..=arr.len() as i32 - 1i32 {
                    let light: RayTracerDemo::RayTracer::Light =
                        arr[idx].clone();
        ...
        pub fn AddLight(thing: &Rc<dyn RayTracerDemo::RayTracer::SceneObject>,
                        ...
                        light: &RayTracerDemo::RayTracer::Light)
         -> RayTracerDemo::Color {
         ...
         -> RayTracerDemo::Vector {
            let RecenterX =
                Rc::from({
                             ...
                             move |x_1: &i32|
                                 (x_1.clone() as f64 - width as f64 / 2.0f64)
                                     / (2.0f64 * width as f64)
                         });
            let RecenterY =
                Rc::from({
                             ...
                             move |y_1: &i32|
                                 -(y_1.clone() as f64 -
                                       height as f64 / 2.0f64) /
                                     (2.0f64 * height as f64)
                         });
            RayTracerDemo::Vector::Norm__Z61A07AF8(&RayTracerDemo::Vector::op_Addition__ZBF05D00(&RayTracerDemo::Vector::op_Addition__ZBF05D00(&camera.get_Forward(),
                                                                                                                                               &RayTracerDemo::Vector::op_Multiply__Z4498946D(&RecenterX(x),
                                                                                                                                                                                              &camera.get_Right())),
                                                                                                 &RayTracerDemo::Vector::op_Multiply__Z4498946D(&RecenterY(y),
                                                                                                                                                &camera.get_Up())))
        }
    ...
    Rc::from(RayTracerDemo::RayTracer::Scene{Things:
                                                 Native::arrayFrom(&[RayTracerDemo::SceneObjects::Plane::_ctor__Z7C613920(&RayTracerDemo::Vector{X:
                                                                     ...
                                                                     RayTracerDemo::SceneObjects::Sphere::_ctor__Z7C613920(&RayTracerDemo::Vector{X:
                                                                         ...
                                                                         Rc<dyn RayTracerDemo::RayTracer::SceneObject>]),
                                             Lights:
                                                 Native::arrayFrom(&[RayTracerDemo::RayTracer::Light{Pos:
                                                                                                         RayTracerDemo::Vector{X:
                                                                                                                                   -2.0f64,
                                                                                                                               Y:
                                                                                                                                   2.5f64,
                                                                                                     ...
                                                                                                     Color:
                                                                                                         RayTracerDemo::Color{R:
                                                                                                                              ...
                                                                                                                              B:
                                                                                                                                  0.07f64,},},
                                                                     RayTracerDemo::RayTracer::Light{Pos:
                                                                                                         RayTracerDemo::Vector{X:
                                                                                                                                   1.5f64,
                                                                                                                               Y:
                                                                                                                                   2.5f64,
    ...
    pub fn renderScene(data: &Rc<MutCell<Vec<u8>>>, x: &i32, y: &i32, w: &i32,
        ...
        RayTracerDemo::RayTracer::Render(&{
                                              let inputRecord:
                                                      Rc<MutCell<Rc<MutCell<Rc<RayTracerDemo::RayTracer::Scene>>>>> =
                                                  Rc::from(MutCell::from(Native::refCell(scene.clone())));
                                              let Camera:
                                                      Rc<RayTracerDemo::RayTracer::Camera> =
                                                  RayTracerDemo::RayTracer::Rotate(&scene.Camera,
                                                                                   angle);
                                              Rc::from(RayTracerDemo::RayTracer::Scene{Things:
                                                                                           inputRecord.Things.clone(),
                                                                                       Lights:
                                                                                           inputRecord.Lights.clone(),
                                                                                       Camera:
                                                                                           Camera,})
                                          }, data, x, y, w, h)
    }
